# jd_scripts(京东脚本)
##  京东免费上车地址: [http://rabbit.clearligh.top/](http://rabbit.clearligh.top/)
...
##   上车教程
1. 添加机器人（vx）
   ![img.png](/images/微信图片_20240904214957.jpg)
2. 输入关建字“登录”根据提示登录京东即可

7. 京豆可以干嘛?
![img_6.png](/images/img_6.png)

##   特别提醒
- 如果发现手机上的京东登录状态失效, 则及时到vx机器人重新登陆或者到[http://rabbit.clearligh.top/]http://rabbit.clearligh.top/)重新提交CK!
